...
from .views import CategoryList, ProductListCreateView, ProductDetailView, MyProductListView, TopViewedProductsView, UploadProductImageView, DeleteProductImageView
