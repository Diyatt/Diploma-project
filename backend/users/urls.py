...
from users.views import LoginView, LogoutView, UserUpdateView, UserDeleteView, ChangePasswordView, VerifyEmailCodeView, ResendVerificationCodeView, UserDetailView
