...
from users.views import LoginView, LogoutView, UserUpdateView, UserListView, UserDeleteView, ChangePasswordView, VerifyEmailCodeView, ResendVerificationCodeView, UserDetailView
